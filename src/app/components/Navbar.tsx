        ...
        <nav className="relative bg-white shadow-md px-6 py-4 w-full z-50">
            ...
            {menuOpen && (
                <ul className="absolute top-full left-0 w-full bg-white shadow-md flex flex-col items-center py-4 space-y-4 md:hidden z-0">
                    ...
                    <li><RubriquesMobile lien="#tarifs" label="Nos Tarifs" onClick={() => setMenuOpen(false)} ></RubriquesMobile></li>
                    <li><RubriquesMobile lien="#tarifs" label="IDK" onClick={() => setMenuOpen(false)} ></RubriquesMobile></li>
                </ul>
            )}
        </nav>
    );
