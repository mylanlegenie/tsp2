        ...
        <div className="space-y-8 text-[17px] leading-relaxed">
          ...
          <div>
            ...
            <ul className="space-y-1">
              <li>
                <strong>Nom de la société :</strong> TAXIS SERVICES PRO
              </li>
              <li>
                <strong>Forme juridique :</strong> SARL au capital de 8 000 €
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-1">
              <li>
                <strong>Téléphone :</strong> 01 41 94 14 04
              </li>
              <li className="flex">
                <strong>Email : </strong>
                <span className="text-blue-600 hover:underline">
                  taxisservicespro@gmail.com
                </span>
              </li>
            </ul>
          </div>
          ...
          <div>
            ...
            <p>
              Le site est hébergé par <strong>VERCEL INC</strong>, 650
              California St, San Francisco, CA 94108, États-Unis
            </p>
          </div>
        </div>
      </motion.section>
